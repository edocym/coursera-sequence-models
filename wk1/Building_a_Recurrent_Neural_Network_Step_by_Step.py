...
def rnn_forward(x, a0, parameters):
    ...
    for t in range(T_x):
        ...
        # def rnn_cell_forward(xt, a_prev, parameters):      # return a_next, yt_pred, cache
...
def lstm_cell_forward(xt, a_prev, c_prev, parameters):
    ...
    c_next = ft * c_prev + it * cct             # same as np.multiply(ft, c_prev) + np.multiply(it, cct)
...
def lstm_forward(x, a0, parameters):
    ...
    for t in range(T_x):
        ...
        # def lstm_cell_forward(xt, a_prev, c_prev, parameters):   # return a_next, c_next, yt_pred, cache
        # cache = (a_next, c_next, a_prev, c_prev, ft, it, cct, ot, xt, parameters)
...
def rnn_backward(da, caches):
    ...
    for t in reversed(range(T_x)):
        ...
        # def rnn_cell_backward(da_next, cache):      # return gradients
        # gradients = {"dxt": dxt, "da_prev": da_prev, "dWax": dWax, "dWaa": dWaa, "dba": dba}
...
def lstm_backward(da, caches):
    ...
    for t in reversed(range(T_x)):
        ...
        # def lstm_cell_backward(da_next, dc_next, cache):     # return gradients
        # gradients = {"dxt": dxt, "da_prev": da_prev, "dc_prev": dc_prev, "dWf": dWf,"dbf": dbf, "dWi": dWi,"dbi": dbi,
        #        "dWc": dWc,"dbc": dbc, "dWo": dWo,"dbo": dbo}
