...
def insert_audio_clip(background, audio_clip, previous_segments):
    ...
    # def get_random_time_segment(segment_ms):   # return (segment_start, segment_end)
    ...
    # def is_overlapping(segment_time, previous_segments):   # return overlap => which is True or False
    retry = 5 # @KEEP 
...
def create_training_example(background, activates, negatives, Ty):
    ...
    for random_activate in random_activates: # @KEEP
        ...
        # def insert_audio_clip(background, audio_clip, previous_segments):  # return new_background, segment_time
